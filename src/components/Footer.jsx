                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className='flex items-center gap-2'
                            ...
                            <span className="self-center lg:text-3xl text-md font-semibold whitespace-nowrap text-black">Jayshree Foundation</span>
                        </Link>
                    </div>
                    <div className="grid  gap-8 sm:gap-6 grid-cols-2">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-black uppercase dark:text-blacke">Resources</h2>
                        ...
                        <div>
                            ...
                            <ul className="text-black dark:text-gray-400 font-medium">
                                <li className="mb-4 text-black">
                                    <Link to="https://www.instagram.com/jayashree_foundation/?igshid=MzRlODBiNWFlZA%3D%3D"
                                        rel="noreferrer noopener"
                                        target="_blank"
                                        className="hover:underline ">Instagram</Link>
                                </li>
                                <li className="text-black">
                                    <Link to="https://www.facebook.com/people/Jayashree-Foundation/100080648706671/?mibextid=LQQJ4d"
                                        rel="noreferrer noopener"
                                        target="_blank"
                                        className="hover:underline">Facebook</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                </div>
                <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8 text-black" />
                <div className="sm:flex sm:items-center sm:justify-between text-black">
                    <span className="text-sm text-black sm:text-center ">© 2023 <a href="https://flowbite.com/" className="hover:underline text-black">Jayshree Foundation</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <Link to="https://www.instagram.com/jayashree_foundation/?igshid=MzRlODBiNWFlZA%3D%3D" className="text-gray-500  hover:text-pink-500">
                        ...
                        <Link to="https://youtube.com/@vedanttewari3944" className="text-black hover:text-gray-900 dark:hover:text-white">
