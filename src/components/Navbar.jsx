            ...
            <dh-component>
                <nav className="w-full border-b">
                    <div className="py-5 md:py-0 container mx-auto px-6 flex items-center justify-between">
                        <Link to={'/'} aria-label="Home. logo" role="img">
                            <img className="w-16 h-16" src={Logo} alt="logo" />
                        </Link>
                        <Link to={'/'}>
                            <p className="font-semibold text-black text-xl">Jayshree Foundation</p>
                        </Link>
                        <div>
                            ...
                            <div id="menu" className={` ${show ? '' : 'hidden'} md:block lg:block `}>
                                ...
                                <ul className="flex text-3xl md:text-base items-center py-10 md:flex flex-col md:flex-row justify-center fixed md:relative top-0 bottom-0 left-0 right-0 bg-white md:bg-transparent z-20">
                                    <li className="text-gray-700 hover:text-gray-900 hover:scale-105 hover:underline transition-all cursor-pointer text-base lg:text-lg pt-10 md:pt-0">
                                        <Link to={'/'}>Home</Link>
                                    </li>
                                    <li className="text-gray-700 hover:text-gray-900 hover:scale-105 hover:underline transition-all cursor-pointer text-base lg:text-lg pt-10 md:pt-0 md:ml-5 lg:ml-10">
